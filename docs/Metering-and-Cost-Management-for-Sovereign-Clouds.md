...
![Sovereign Cloud Architecture with Integrated Metering and Cost Management](architecture-diagram.png)

*Figure 1: Sovereign cloud architecture. All components — from provisioning
through metering, costing, and reporting — run within the sovereign perimeter.
Green dashed arrows indicate metering data flowing from the cluster fleet to
the cost management engine, and cost reports flowing to billing systems.*
