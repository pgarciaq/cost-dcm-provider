...
scale = CONTENT_WIDTH_EMU / (img_w * 9525)  # 9525 EMU per pixel at 96 DPI
...
parts.append(bold_intro("Tenant Self-Service. ", "Tenants can view their own metering and cost data through read-only dashboards, understanding their consumption without needing access to the underlying cost management system."))
